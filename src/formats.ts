...
/**
 * Wraps the text inside a rectangular ASCII border.
 * 
 * Example:
 * // +------------------+
 * // |   Hello World    |
...
const borderedFormat: CommentFormat = {
    name: "Borderd",
    docComment: `Wraps text inside a rectangular ASCII border.
Example:
+------------------+
|   Hello World    |
+------------------+`,
    ...
    getCommentString(content, language, args: Record<string, any>) {
        ...
        const defaultSize = Number(config.get("styled-commenter.styles.bordered.defaultSize"))
        const minPadding = Number(config.get("styled-commenter.styles.bordered.minPadding"))
        const leftMargin = Number(config.get("styled-commenter.styles.bordered.leftMargin"))
...
const boxedFormat: CommentFormat = {
    name: "Boxed",
        docComment: `Wraps text inside a heavy double-line ASCII box.
...
/////////////////////////////`,
    ...
    getCommentString(content, language, args: Record<string, any>) {
        ...
        const config = vscode.workspace.getConfiguration()
        const defaultSize = Number(config.get("styled-commenter.styles.boxed.defaultSize"))
        const minPadding = Number(config.get("styled-commenter.styles.boxed.minPadding"))
...
const headerFormat: CommentFormat = {
    name: "Header",
    docComment: `Creates a header line with the text centered between dashes.
...
// ------- Hello World -------`,
    ...
    getCommentString(content, language, args: Record<string, any>) {
        ...
        const config = vscode.workspace.getConfiguration()
        const defaultSize = Number(config.get("styled-commenter.styles.line.defaultSize"))
        const minPadding = Number(config.get("styled-commenter.styles.line.minPadding"))
